...
html_data_content = response.content

soup = BeautifulSoup(html_data_content, 'html.parser')
...
def make_graph(data, revenue, title):
    ...
    ax1.plot(data['Date'], data['Close'], color='tab:blue', label='Stock Price')
    ax1.tick_params(axis='y', labelcolor='tab:blue')

    ax2 = ax1.twinx()
    ax2.set_ylabel('Revenue', color='tab:green')
    ax2.plot(revenue['Date'], revenue['Revenue'], color='tab:green', label='Revenue')
